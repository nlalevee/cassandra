...
import org.apache.cassandra.hadoop.hive.input.HiveCassandraStandardColumnInputFormat;
import org.apache.cassandra.hadoop.hive.output.HiveCassandraOutputFormat;
import org.apache.cassandra.hadoop.hive.serde.CassandraColumnSerDe;
    ...
    public void configureTableJobProperties(TableDesc tableDesc, Map<String, String> jobProperties)
    {
        ...
        if (columnInfo == null)
        {
            columnInfo = StandardColumnSerDe.createColumnMappingString(tableProperties
                    .getProperty(org.apache.hadoop.hive.serde.Constants.LIST_COLUMNS));
        }

        jobProperties.put(StandardColumnSerDe.CASSANDRA_COL_MAPPING, columnInfo);

        jobProperties.put(StandardColumnSerDe.CASSANDRA_HOST, tableProperties.getProperty(
                StandardColumnSerDe.CASSANDRA_HOST, StandardColumnSerDe.DEFAULT_CASSANDRA_HOST));

        jobProperties.put(StandardColumnSerDe.CASSANDRA_PORT, tableProperties.getProperty(
                StandardColumnSerDe.CASSANDRA_PORT, StandardColumnSerDe.DEFAULT_CASSANDRA_PORT));

        jobProperties.put(StandardColumnSerDe.CASSANDRA_PARTITIONER, tableProperties.getProperty(
                StandardColumnSerDe.CASSANDRA_PARTITIONER, "org.apache.cassandra.dht.RandomPartitioner"));
        ...
        jobProperties.put(StandardColumnSerDe.CASSANDRA_CONSISTENCY_LEVEL, tableProperties.getProperty(
                StandardColumnSerDe.CASSANDRA_CONSISTENCY_LEVEL, StandardColumnSerDe.DEFAULT_CONSISTENCY_LEVEL));
        ...
        jobProperties.put(
                StandardColumnSerDe.CASSANDRA_SLICE_PREDICATE_SIZE,
        ...
        jobProperties.put(
                StandardColumnSerDe.CASSANDRA_BATCH_MUTATION_SIZE,
