...
public class CassandraColumnSerDe extends AbstractColumnSerDe
{
    ...
    {
        return CassandraLazyFactory.createLazyStructInspector(serdeParams.getColumnNames(),
                serdeParams.getColumnTypes(), validatorType, serdeParams.getSeparators(),
                serdeParams.getNullSequence(), serdeParams.isLastColumnTakesRest(), serdeParams.isEscaped(),
                serdeParams.getEscapeChar());
    }

    /**
     * Parse or create the validator types. If <code>CASSANDRA_VALIDATOR_TYPE</code> is defined in the property, it will
     ...
     * @throws SerDeException
     *             when the number of validator types is fewer than the number of columns or when no matching validator
     *             type is found in Cassandra.
     */
     ...
     * 
     * @param columnList
     *            a list of column validator type in String format
