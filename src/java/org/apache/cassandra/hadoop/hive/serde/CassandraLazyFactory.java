...
import org.apache.cassandra.hadoop.hive.serde.lazy.objectinspector.CassandraLazyObjectInspectorFactory;
import org.apache.cassandra.hadoop.hive.serde.lazy.objectinspector.CassandraValidatorObjectInspector;
import org.apache.cassandra.hadoop.hive.serde2.lazy.CassandraLazyInteger;
import org.apache.cassandra.hadoop.hive.serde2.lazy.CassandraLazyLong;
...
public class CassandraLazyFactory
{
     ...
     */
    public static ObjectInspector createLazyObjectInspector(AbstractType validator, byte[] separator,
    ...
    public static ObjectInspector createLazyStructInspector(List<String> columnNames, List<TypeInfo> typeInfos,
            List<AbstractType> validatorTypes, byte[] separators, Text nullSequence, boolean lastColumnTakesRest,
            boolean escaped, byte escapeChar)
    {
        if (validatorTypes.size() == 0)
        {
            return LazyFactory.createLazyStructInspector(columnNames, typeInfos, separators, nullSequence,
        ...
        {
            columnObjectInspectors.add(createLazyObjectInspector(validatorTypes.get(i), separators, 1, nullSequence,
                    escaped, escapeChar));
        }
