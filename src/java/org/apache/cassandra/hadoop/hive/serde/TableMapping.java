...
public abstract class TableMapping
{
    ...
    public Writable getWritable(List<? extends StructField> fields, List<Object> list,
    ...
    public abstract Writable write(byte[] keyBytes, List<? extends StructField> fields, List<Object> list,
            List<? extends StructField> declaredFields) throws IOException;
     ...
     * 
     * @param index
     *            the index of the object to be seralized.
     * @param fields
     *            a list of fields
     * @param list
     *            a list of objects
     ...
     * @throws IOException
     */
    protected byte[] serializeToBytes(int index, List<? extends StructField> fields, List<Object> list,
            List<? extends StructField> declaredFields) throws IOException
    {
        return serializeToBytes(fields.get(index).getFieldObjectInspector(), list.get(index),
     ...
     * 
     * @param index
     *            the index of the field to be deserialized.
     * @param declaredFields
     *            a list of declared fields
    ...
    protected boolean useJsonSerialize(int index, List<? extends StructField> declaredFields)
    {
        return (declaredFields == null
                || declaredFields.get(index).getFieldObjectInspector().getCategory().equals(Category.PRIMITIVE) || useJSONSerialize);
    }
     ...
     *            true to use json serialization
    ...
    protected byte[] serializeToBytes(ObjectInspector foi, Object obj, boolean useJsonSerialize) throws IOException
    {
        ...
        boolean isNotNull;
        if (!foi.getCategory().equals(Category.PRIMITIVE) && useJsonSerialize)
        {
