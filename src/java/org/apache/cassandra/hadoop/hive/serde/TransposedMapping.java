...
import org.apache.cassandra.hadoop.hive.output.CassandraSuperPut;
...
public class TransposedMapping extends TableMapping
{
    ...
    public TransposedMapping(String colFamily, List<String> columnNames, SerDeParameters serdeParams)
            ...
            List<? extends StructField> declaredFields) throws IOException
    {
        ...
        else
        {
            ...
            byte[] colName = serializeToBytes(fields.get(columnName).getFieldObjectInspector(), list.get(columnName),
    ...
    /**
     * Save the index of :column, :value and :subcolumn and the transposedTable flag if and only if this is a transposed
     * table.
     * 
     * @throws SerDeException
     */
